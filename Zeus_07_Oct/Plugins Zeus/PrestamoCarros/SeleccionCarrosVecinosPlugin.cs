...
{
    public class SeleccionCarrosVecinosPlugin : IPlugin
    {
        ...
        public string Descripcion
        {
            ...
            {
                return
                    "Módulo de selección de material mayor de apoyo.";
            }
        }
...
#endif
            // menu
            ts = new ToolStripMenuItem("M.M. Apoyo", null, new EventHandler(MenuClick)) { Name = "config" };
            ZeusWin.AgregarConfig(ts);

            // boton
            tb = new ToolStripButton("M.M. Apoyo", Resource1.ico1, ButtonClick)
            {
                Name = "cVecinosBtn",
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            {
                case "cVecinosBtn":
                    FormularioCarrosVecinos sigeb = new FormularioCarrosVecinos();
                    sigeb.ShowDialog();
