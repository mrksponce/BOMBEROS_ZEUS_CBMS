...
namespace PreparaMaterialMayor
{
    public class PreparaMaterialPlugin : IPlugin
    {
        ...
        public string Descripcion
        {
            ...
            { 
                return 
                    "Módulo de Puesta en Servicio Masiva del Material Mayor"; 
            }
        }
...
#endif
            // menu
            ts = new ToolStripMenuItem("Configurar M.M.", null, new EventHandler(MenuClick)) {Name = "config"};
            ZeusWin.AgregarConfig(ts);
            
            // boton
            tb = new ToolStripButton("Preparar M.M.", Resources.ico1, ButtonClick)
            {
                Name = "PreparaBtn",
        ...
        public string Name
        {
            get { return "Preparar Material Mayor"; }
        }
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            {
                case "PreparaBtn":
                    //var mm = new MaterialMayor_Config { Icon = Icon.FromHandle(Resources.ico1.GetHicon()), ZeusWin = this };
                    //mm.ShowDialog();
                    var pm = new EntregaDeTurno();
                    pm.ShowDialog();
