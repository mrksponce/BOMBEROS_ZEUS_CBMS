...
{
    public class FormularioRescatePlugin : IPlugin
    {
...
#endif
            // menu
            ts = new ToolStripMenuItem("SERVICIO", null, new EventHandler(MenuClick)) { Name = "config" };
            ZeusWin.AgregarConfig(ts);

            // boton
            tb = new ToolStripButton("SERVICIO", Resource1.ico1, ButtonClick)
            {
                Name = "fServicioBtn",
        ...
        {
            get { return "Cuerpo de Bomberos Puente Alto"; }
        }
        ...
        private void ButtonClick(object sender, EventArgs e)
        {
            ...
            {
                case "fServicioBtn":
                    FormularioServicio f = new FormularioServicio();
                    f.ShowDialog();
