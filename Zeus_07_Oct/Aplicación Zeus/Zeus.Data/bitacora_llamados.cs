...
namespace Zeus.Data
{
    ...
    public class bitacora_llamados
    {
        ...
        //### Actualiza Sólo 1 Horas y Envía JSON a ZEUS Web
        public void Actualizar_Una_Clave(int idExpediente, int idCarro, string seis_cero, string seis_tres, string seis_siete, string seis_ocho, string seis_nueve, string seis_dies, string stClave)
        {
            CnxBase myBase = new CnxBase();
            NpgsqlConnection myConn = myBase.OpenConnection(myBase.cnxString);
            bitacora_llamados bll = new bitacora_llamados();
