...
public class p_paradero
{
	...
	public void Insert(p_paradero myp_paradero)
	{
		...
		string reqSQL = "INSERT INTO p_paradero (gid,id,avenida,sgc1,sgc2,geom) VALUES ("+myp_paradero.gid+","+myp_paradero.id+",'"+myp_paradero.avenida+"',"+myp_paradero.sgc1+",'"+myp_paradero.sgc2+"','"+myp_paradero.the_geom+"')";
			try
			{
	...
	{
		CnxBase myBase = new CnxBase();
		string reqSQL = "UPDATE p_paradero SET gid="+myp_paradero.gid+",id="+myp_paradero.id+",avenida='"+myp_paradero.avenida+"',sgc1="+myp_paradero.sgc1+",sgc2='"+myp_paradero.sgc2+"',geom='"+myp_paradero.the_geom+"' WHERE (gid="+myp_paradero.gid+")";
			try
			{
				NpgsqlConnection myConn = myBase.OpenConnection(myBase.cnxString);
				NpgsqlCommand myCommand = new NpgsqlCommand(reqSQL,myConn);
