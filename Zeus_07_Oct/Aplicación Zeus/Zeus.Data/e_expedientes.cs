...
namespace Zeus.Data
{
    ...
    public class e_expedientes
    {
        ...
        private string _e_lat_long;
        public string e_lat_long
        {
            get { return _e_lat_long; }
            set { _e_lat_long = value; }
        }

        //###
        private System.String _comuna_real;
        public System.String comuna_real
        {
            get
            {
                return _comuna_real;
        ...
        public e_expedientes(System.Int32 id_expediente, System.String cero5, System.String seis2, System.Double puntoX, System.String comuna, System.String geoz, System.Boolean activo, System.Double puntoY, System.DateTime hora, System.DateTime fecha, System.String poblacion_villa, System.String block, System.String casa, System.String telefono, System.String quien_llama, System.String compania, System.String descripcion, System.Int32 codigo_llamado, System.Int32 codigo_principal, System.Int32 id_operadora, bool enviado_redtic, int id_voluntario, int id_area, System.String e_lat_long, System.String comuna_real)
        {
            ...
            this.e_lat_long = e_lat_long;
            this.comuna_real = comuna_real;
        }
        ...
        public void Update(e_expedientes mye_expedientes)
        {
            ...
            string reqSQL = "UPDATE e_expedientes SET cero5='" + mye_expedientes.cero5 +
                ...
                "',seis16=" + mye_expedientes.seis16 +
                ",comuna_real='" + mye_expedientes.comuna_real +
        ...
        public e_expedientes getObjecte_expedientes(System.Int32 myID)
        {
            ...
            try
            {
                ...
                if (myReader.Read())
                {
                    ...
                    mye_expedientes.e_lat_long = myReader[47].ToString();
                    mye_expedientes.comuna_real = myReader[48].ToString();
                }
                myBase.CloseConnection(myConn);
            }
            catch (Exception myErr)
        ...
        public DataSet Gete_expedientes_operadora_all(int id_operadora)
        {
            ...
            string reqSQL = "SELECT id_expediente, seis2, cero5, z_llamados.clave, fecha, sit_controlada from e_expedientes, z_llamados where activo=true and e_expedientes.codigo_principal=z_llamados.codigo_llamado";
            try
            {
                CnxBase myD4MCnx = new CnxBase();
                DataSet myResult = myD4MCnx.GetDataSet(reqSQL);
        ...
        {
            CnxBase myBase = new CnxBase();
            string reqSQL = "SELECT a.seis2, a.cero5, b.clave, b.descripcion, a.id_area, a.material_despachado, a.plano, a.codigo_principal, a.comuna FROM e_expedientes a left join z_llamados b on a.codigo_llamado = b.codigo_llamado WHERE a.id_expediente = " + idExpediente;
            try
            {
                CnxBase myD4MCnx = new CnxBase();
                DataSet myResult = myD4MCnx.GetDataSet(reqSQL);
        ...
        //### Guardar Lat Long para App Twitter
        ...
        //### Guardar Lat Long para App Web
        public void AgregarLatLongWeb(int idExpediente, string strLatLong)
        {

            string strLatLong2 = strLatLong.ToString().Replace("+", " ");

            CnxBase myBase = new CnxBase();
            string reqSQL = "UPDATE e_expedientes SET e_lat_long = '" + strLatLong2 + "' WHERE id_expediente = " + idExpediente + "";
            try
            {
                NpgsqlConnection myConn = myBase.OpenConnection(myBase.cnxString);
                NpgsqlCommand myCommand = new NpgsqlCommand(reqSQL, myConn);
        ...
        //### Obtener Identificador de Tono para ZEUS Alerta 
        public string Get_Id_Tono(string IdActo)
        {
            CnxBase myBase = new CnxBase();
            string reqSQL = "SELECT geobit_rep_id_acto(" + IdActo + ")";
            string ret;
            try
            {
                NpgsqlConnection myConn = myBase.OpenConnection(myBase.cnxString);
