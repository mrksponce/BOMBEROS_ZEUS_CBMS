...
#End Region
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        If Not clb.CheckedItems.Count = 0 Then
            If MapWinUtility.Logger.Msg("Warning! This will permanently remove the selected field(s) and all data they contain." + Environment.NewLine + Environment.NewLine + "Do you wish to proceed?", MsgBoxStyle.Exclamation Or MsgBoxStyle.YesNo, "Confirm delete") = MsgBoxResult.Yes Then
