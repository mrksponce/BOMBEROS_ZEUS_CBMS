...
'10/04/2008 - Enables usage of Picture property.
'********************************************************************************************************

Public Class ToolStripMenuItem
    Implements MapWindow.Interfaces.MenuItem
    ...
    Public ReadOnly Property IsFirstVisibleSubToolStripMenuItem() As Boolean Implements MapWindow.Interfaces.MenuItem.IsFirstVisibleSubmenuItem
        Get
    ...
    Public Property BeginsGroup() As Boolean Implements MapWindow.Interfaces.MenuItem.BeginsGroup
        Get
    ...
    Public Property Category() As String Implements MapWindow.Interfaces.MenuItem.Category
        Get
            Return m_Category
        End Get
    ...
    Public Property Checked() As Boolean Implements MapWindow.Interfaces.MenuItem.Checked
        Get
    ...
    Public Property Cursor() As Cursor Implements MapWindow.Interfaces.MenuItem.Cursor
        Get
            Return m_Cursor
        End Get
    ...
    Public Property Description() As String Implements MapWindow.Interfaces.MenuItem.Description
        Get
    ...
    Public Property Displayed() As Boolean Implements MapWindow.Interfaces.MenuItem.Displayed
        Get
            Return m_Displayed
        End Get
        Set(ByVal Value As Boolean)
    ...
    Public Property Enabled() As Boolean Implements MapWindow.Interfaces.MenuItem.Enabled
        Get
    ...
    Public ReadOnly Property Name() As String Implements MapWindow.Interfaces.MenuItem.Name
        Get
            Return m_Name
        End Get
    End Property

    Public ReadOnly Property NumSubItems() As Integer Implements MapWindow.Interfaces.MenuItem.NumSubItems
        Get
    ...
    Public Property Picture() As Object Implements MapWindow.Interfaces.MenuItem.Picture
        ...
        Set(ByVal Value As Object)
            ...
            'Earljon Hidalgo 10/04/2008 Enables usage of Picture property.
            m_Menu.Image = Value
            m_Picture = Value
        End Set
    End Property
    ...
    Public Function SubItem(ByVal MenuName As String) As MapWindow.Interfaces.MenuItem Implements MapWindow.Interfaces.MenuItem.SubItem
        If m_IsSeparator Then Return Nothing
    ...
    <CLSCompliant(False)> _
    Public Function SubItem(ByVal Index As Integer) As MapWindow.Interfaces.MenuItem Implements MapWindow.Interfaces.MenuItem.SubItem
        Try
            If m_IsSeparator Then Return Nothing
    ...
    Public Property Text() As String Implements MapWindow.Interfaces.MenuItem.Text
        Get
            If m_IsSeparator Then Return "-"
    ...
    Public Property Tooltip() As String Implements MapWindow.Interfaces.MenuItem.Tooltip
        Get
            Return m_Tooltip
        End Get
        Set(ByVal Value As String)
    ...
    Public Property Visible() As Boolean Implements MapWindow.Interfaces.MenuItem.Visible
        Get
            If m_IsSeparator Then
