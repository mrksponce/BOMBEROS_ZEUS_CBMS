...
Friend Class PointImageSchemeForm
    ...
    Private m_ImageScheme As PointImageScheme
    ...
    Public Sub New(ByVal DialogProvider As IWindowsFormsEditorService, ByVal Scheme As PointImageScheme)
        MyBase.New()
...
#End Region
    ...
    Private Sub cmbField_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbField.SelectedIndexChanged
        ...
        For Each s As String In vals
            ...
            Dim imgIdx As Long = m_ImageScheme.ImageIndex(s)
    ...
    Private Sub SelectItem(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If selectForm.ShowDialog() = DialogResult.OK Then
            If selectForm.chbHidePoint.Checked Then
                m_ImageScheme.Visible(tag) = False
                ...
                sf = Nothing
            Else
                Dim newIdx As Long = selectForm.newidx
                If newIdx = -1 Then Return
                m_ImageScheme.ImageIndex(tag) = newIdx
    ...
    Public ReadOnly Property Retval() As PointImageScheme
        Get
