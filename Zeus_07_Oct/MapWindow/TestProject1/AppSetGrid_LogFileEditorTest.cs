...
namespace TestProject1
{
    ...
    /// <summary>
    ///This is a test class for AppSetGrid_LogFileEditorTest and is intended
    ///to contain all AppSetGrid_LogFileEditorTest Unit Tests
    ///</summary>
    [TestClass()]
    public class AppSetGrid_LogFileEditorTest
    {
        ...
        /// <summary>
        ///A test for LogFileEditor Constructor
        ///</summary>
        [TestMethod()]
        public void AppSetGrid_LogFileEditorConstructorTest()
        {
            AppSetGrid.LogFileEditor target = new AppSetGrid.LogFileEditor();
