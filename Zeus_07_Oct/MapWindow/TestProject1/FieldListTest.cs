...
namespace TestProject1
{
    ...
    /// <summary>
    ///This is a test class for FieldListTest and is intended
    ///to contain all FieldListTest Unit Tests
    ///</summary>
    [TestClass()]
    public class FieldListTest
    {
        ...
        {
            FieldList target = new FieldList(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for FieldList Constructor
        ///</summary>
        [TestMethod()]
        public void FieldListConstructorTest()
        {
            FieldList target = new FieldList();
