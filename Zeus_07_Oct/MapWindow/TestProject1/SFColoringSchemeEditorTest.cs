...
namespace TestProject1
{
    ...
    /// <summary>
    ///This is a test class for SFColoringSchemeEditorTest and is intended
    ///to contain all SFColoringSchemeEditorTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SFColoringSchemeEditorTest
    {
        ...
        {
            SFColoringSchemeEditor target = new SFColoringSchemeEditor(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for SFColoringSchemeEditor Constructor
        ///</summary>
        [TestMethod()]
        public void SFColoringSchemeEditorConstructorTest()
        {
            SFColoringSchemeEditor target = new SFColoringSchemeEditor();
