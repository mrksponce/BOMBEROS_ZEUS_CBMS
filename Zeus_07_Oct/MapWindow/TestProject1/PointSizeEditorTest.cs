...
namespace TestProject1
{
    ...
    /// <summary>
    ///This is a test class for PointSizeEditorTest and is intended
    ///to contain all PointSizeEditorTest Unit Tests
    ///</summary>
    [TestClass()]
    public class PointSizeEditorTest
    {
        ...
        {
            PointSizeEditor target = new PointSizeEditor(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for PointSizeEditor Constructor
        ///</summary>
        [TestMethod()]
        public void PointSizeEditorConstructorTest()
        {
            PointSizeEditor target = new PointSizeEditor();
